...
// Add this to include the FFI module
#[cfg(any(feature = "ffi", crate_type = "cdylib"))]
pub mod ffi;

// Add this to make regex available to the FFI module
#[cfg(any(feature = "ffi", crate_type = "cdylib"))]
extern crate regex as regex_interfaces;